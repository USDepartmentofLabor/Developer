...
<p>View OSHA's metric codes on the <a href="https://enforcedata.dol.gov/views/data_catalogs.php" target="_blank">'Data Enforcement' page under 'OSHA Enforcement Data'</a> or <a href="{{ site.baseurl }}/docs/IMISCodes.xlsx" target="_blank">Downloaded</a>.
</p>
