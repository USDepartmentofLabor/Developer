---
layout: post
title: BLS Consumer Price Indexes (CPI) Dataset
created: 1359576522
---
...
### Dataset Metadata  
http://api.dol.gov/V1/Statistics/CPI/$metadata

[Sample the BLS Consumer Price Indexes (CPI) Dataset](https://devtools.dol.gov/APISampler/Home/Index1?datasetName=BLS Consumer Price Index (CPI))  
